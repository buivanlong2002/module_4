...
import com.codegym.springsecurityjwt.jwt.service.JwtResponse;
import com.codegym.springsecurityjwt.jwt.service.JwtService;
    ...
    public ResponseEntity<?> login(@RequestBody User user) {
        ...
        return ResponseEntity.ok(
                new JwtResponse(
                        ...
                        userInfo.getUsername(),   // name (bạn có thể sửa nếu muốn)
